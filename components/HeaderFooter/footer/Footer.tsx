...
const Footer = ({ settings }: FooterProps) => {
  ...
  const siteTitle = (settings as GeneralSettings)?.siteName || 'جمعية وئام للتنمية البشرية للأيتام';
  return (
    <div className='bg-slate-100 dark:bg-darkTheme3 p-4 relative -bottom-1'>
